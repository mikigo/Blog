import{_ as s,c as n,o as e,R as p}from"./chunks/framework.ButFe1M8.js";const h=JSON.parse('{"title":"平台权限管理前端设计","description":"","frontmatter":{"Author":"路斐"},"headers":[],"relativePath":"编程基础/前后端/前端/研测平台权限管理前端设计.md","filePath":"编程基础/前后端/前端/研测平台权限管理前端设计.md","lastUpdated":1740102501000}'),t={name:"编程基础/前后端/前端/研测平台权限管理前端设计.md"};function o(l,a,i,r,c,u){return e(),n("div",null,a[0]||(a[0]=[p(`<h1 id="平台权限管理前端设计" tabindex="-1">平台权限管理前端设计 <a class="header-anchor" href="#平台权限管理前端设计" aria-label="Permalink to &quot;平台权限管理前端设计&quot;">​</a></h1><h2 id="用户登录流程" tabindex="-1">用户登录流程 <a class="header-anchor" href="#用户登录流程" aria-label="Permalink to &quot;用户登录流程&quot;">​</a></h2><h3 id="用户认证" tabindex="-1">用户认证 <a class="header-anchor" href="#用户认证" aria-label="Permalink to &quot;用户认证&quot;">​</a></h3><p>平台使用 <a href="https://jwt.io/" target="_blank" rel="noreferrer">JWT</a>(JSON Web Token) 进行用户认证，客户端通过登录接口获取 JWT 并保存，在访问接口数据时，需要携带 JWT，将 JWT 放在请求的 <code>Authorization</code> 头部。例如：</p><p>登录</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>import axios from &#39;axios&#39;;</span></span>
