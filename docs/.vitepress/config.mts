            ...
            sidebar: {
                ...
                "编程基础": [
                        ...
                        items: [
                            {
                                ...
                                items: [
                                    ...
                                    {text: "FFmpeg常用命令与参数解释", link: "编程基础/Linux/工具使用/FFmpeg常用命令与参数解释"},
                            ...
                            },
                            {
                                ...
                                items:[
                                    ...
                                    {text: "Linux上远程桌面VNC配置", link: "编程基础/Linux/方案教程/Linux上远程桌面VNC配置"},
                    ...
                    },
                    {
                        text: "Python",
                        items: [
                            {text: "Linux上如何选择用pip3还是sudopip3", link: "/编程基础/Python/Linux上如何选择用pip3还是sudopip3"},
                            ...
                            {text: "Python最强静态代码检查&格式化工具Ruff", link: "/编程基础/Python/Python最强静态代码检查&格式化工具Ruff"},
                        ...
                        items: [
                            {
                                text:"图像",
                                items: [
                                    {text: "智能化功能测试", link: "/编程基础/人工智能/图像/智能化功能测试"},
                                    {text: "智能化性能测试", link: "/编程基础/人工智能/图像/智能化性能测试"},
                                ]
                            }
                        ]
                    },
                        ...
                        items: [
                            {
                                text: "前端",
                                items: [
                                    {text: "CSS基础", link: "/前后端/前端/CSS基础"},
                                    {text: "html基础", link: "/前后端/前端/html基础"},
                                    {text: "JS基础", link: "/前后端/前端/JS基础"},
                                    {text: "Linux上安装Nodejs", link: "/前后端/前端/Linux上安装Nodejs"},
                                    {text: "Vue基础", link: "/前后端/前端/Vue基础"},
                                    {text: "Web基础", link: "/前后端/前端/Web基础"},
                                    {text: "测开前端学习基础分享", link: "/前后端/前端/测开前端学习基础分享"},
                                    {text: "研测平台权限管理前端设计", link: "/前后端/前端/研测平台权限管理前端设计"},
                                ]
                            },
                            {
                                text: "后端",
                                items: [
                                    {text: "Django基础知识", link: "/前后端/后端/Django基础知识"},
                                    {text: "Django进阶技巧", link: "/前后端/后端/Django进阶技巧"},
                                    {text: "FastAPI—8小时入门版", link: "/前后端/后端/FastAPI—8小时入门版"},
                                    {text: "MySQL基础", link: "/前后端/后端/MySQL基础"},
                                ]
                            }
                        ]
                    },
                    {
                        text: "网络爬虫",
                        items: [
                            {text: "Httpx", link: "/网络爬虫/Httpx"},
                            {text: "Requests", link: "/网络爬虫/Requests"},
                            {text: "Scrapy", link: "/网络爬虫/Scrapy"},
                        ]
                    }
                ],
                "技术文档":[
                    {
                        text: "根因分析",
                        items: [
                            {text: "Python调用动态库运行时报静态TLS块不能分配内存根因分析报告", link: "/技术文档/根因分析/Python调用动态库运行时报静态TLS块不能分配内存根因分析报告"},
                            {text: "rootfs进入MATE桌面后打开终端不能执行reboot指令根因分析", link: "/技术文档/根因分析/rootfs进入MATE桌面后打开终端不能执行reboot指令根因分析"},
                        ]
                    },
                    {
                        text: "技术调研",
                        items: [
                            ...
                            {text: "youqu3中断任务续跑功技术能调研", link: "/技术文档/技术调研/youqu3中断任务续跑功技术能调研"},
                            {text: "《Avocado和YouQu对比》调研报告", link: "/技术文档/技术调研/《Avocado和YouQu对比》调研报告"},
                            {text: "《可用于UOS桌面应用性能自动化工具》调研报告", link: "/技术文档/技术调研/《可用于UOS桌面应用性能自动化工具》调研报告"},
                            {text: "《命令行用例转换自动化测试》调研报告", link: "/技术文档/技术调研/《命令行用例转换自动化测试》调研报告"},
                            {text: "《应用于桌面应用压力测试的模拟输入工具》调研报告", link: "/技术文档/技术调研/《应用于桌面应用压力测试的模拟输入工具》调研报告"},
                            {text: "《获取影院播放视频FPS方法》调研报告", link: "/技术文档/技术调研/《获取影院播放视频FPS方法》调研报告"},
                            {text: "《针对PMS用例数据检查与自动化工程CSV文件数据同步的方法》调研报告", link: "/技术文档/技术调研/《针对PMS用例数据检查与自动化工程CSV文件数据同步的方法》调研报告"},
                    ...
                    },
                    {
                        text: "专利交底书",
                        items: [
                            {text: "一种dock栏展示和交互方法技术交底书", link: "/技术文档/专利交底书/一种dock栏展示和交互方法技术交底书"},
                            {text: "一种基于Linux系统执行自动化测试用例实现负载均衡的技术交底书", link: "/技术文档/专利交底书/一种基于Linux系统执行自动化测试用例实现负载均衡的技术交底书"},
                            {text: "一种基于图像识别的桌面应用控件智能标注的交底书", link: "/技术文档/专利交底书/一种基于图像识别的桌面应用控件智能标注的交底书"},
                            {text: "一种基于机器学习智能识别元素控件的UI自动化测试方法", link: "/技术文档/专利交底书/一种基于机器学习智能识别元素控件的UI自动化测试方法"},
                            {text: "一种定位目标图片坐标的图像识别技术交底书", link: "/技术文档/专利交底书/一种定位目标图片坐标的图像识别技术交底书"},
                            {text: "一种对使用Linux包管理器安装的Python包进行虚拟化的技术交底书", link: "/技术文档/专利交底书/一种对使用Linux包管理器安装的Python包进行虚拟化的技术交底书"},
                            {text: "一种机器分离的应用响应性能自动化测试方案技术交底书", link: "/技术文档/专利交底书/一种机器分离的应用响应性能自动化测试方案技术交底书"},
                            {text: "一种系统文件基于事物属性对其进行多维度多空间管理方法的交底书", link: "/技术文档/专利交底书/一种系统文件基于事物属性对其进行多维度多空间管理方法的交底书"},
                            {text: "一种自动化测试用例步骤中断后恢复执行的技术交底书", link: "/技术文档/专利交底书/一种自动化测试用例步骤中断后恢复执行的技术交底书"},
                            {text: "一种自动安装镜像的技术交底书", link: "/技术文档/专利交底书/一种自动安装镜像的技术交底书"},
                            {text: "一种针对Linux系统异常命令的测试方法技术交底书", link: "/技术文档/专利交底书/一种针对Linux系统异常命令的测试方法技术交底书"},
                            {text: "基于shell的测试框架技术交底书", link: "/技术文档/专利交底书/基于shell的测试框架技术交底书"},
                            {text: "基于视频播放器外部获取播放中视频FPS的测试技术交底书", link: "/技术文档/专利交底书/基于视频播放器外部获取播放中视频FPS的测试技术交底书"},
                        ]
                    }
                ],
                "分享有趣": [
